...
function FindPassword({ onClose, isForgotPasswordPopupOpen }) {
    ...
    const handleUserCheck = () => {
        ...
        axios
            .post(`${BASE_URL}/users/userCheck`, { username, email }, axiosConfig)
            .then((response) => {
            ...
            {isForgotPasswordPopupOpen &&
                ((step === 1 && (
                    <div className="popup">
                        ...
                        <div>
                            <button className="Find_button" onClick={handleUserCheck}>
                                확인
                            </button>
                        </div>
                        <div>
                    ...
                    (step === 2 && (
                        <div className="popup">
                            ...
                            <button className="Find_button" onClick={handleUpdatePassword}>
                                비밀번호 등록
                            </button>
                            <button
