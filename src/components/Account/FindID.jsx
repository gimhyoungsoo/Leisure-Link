...
function FindID({ onClose, isFindIdPopupOpen }) {
    ...
    const { setInvalidEmail, setInvalidPassword } = LoginActions();
    ...
    const handleFindId = () => {
        ...
        axios
            .post(`${BASE_URL}/users/emailFind`, { username }, axiosConfig)
            .then((response) => {
            ...
            {isFindIdPopupOpen &&
                ((step === 1 && (
                    <div className="popup">
                        ...
                        <div>
                            <button className="Find_button" onClick={handleFindId}>
                                찾기
                            </button>
                        </div>
                        <div>
